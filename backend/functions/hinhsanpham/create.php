        ...
        <div class="row">
            ...
            <main class="col-md-9 col-lg-10 ml-sm-auto">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-2 pb-1 mb-2 border-bottom">
                    <h1 class="h2">Thêm hình sản phẩm</h1>
                </div>
                <!--Kết nối database-->
                <?php
                    //Hiển thị lỗi
                ...
                <div>
                    <form id="frmCreate" name="frmCreate" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="hsp_ten" class="col-sm-3 control-label">File ảnh <span style="color:red;">(*)</span> :</label>
                            <div class="col-sm-9">
                                <input class="form-control" type="file" id="hsp_ten" name="hsp_ten">
                            </div>
                        </div>
                        <div class="row">
                            <label for="hsp_mota" class="col-sm-3">Your image:</label>
                            <div class="col-sm-9">
                                <div>
                    ...
                    <?php
                        if (isset($_POST['btnCreate'])){
                            ...
                            if(isset($_FILES['hsp_ten'])){
                                ...
                                //--------------------------
                                $sql = "INSERT INTO hinhsanpham (hsp_ten, sp_ma) VALUES ('$ten', $sp_ma);";
