    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 col-lg-10 ml-sm-auto">
                ...
                <!--Lấy dòng dữ liệu được chọn để edit-->
                <?php
                ...
                $lspRow = mysqli_fetch_array($resultSelect, MYSQLI_ASSOC);
                ?>
                <div>
                    <form id="frmCreate" name="frmCreate" method="post" action="">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="lsp_ten" name="lsp_ten" placeholder="Tên loại sản phẩm" value="<?= $lspRow['lsp_ten']?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="lsp_mota" class="col-sm-3 control-label">Mô tả <span style="color:red;">(*)</span> :</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" id="lsp_mota" name="lsp_mota" placeholder="Mô tả" value="<?= $lspRow['lsp_mota']?>"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
