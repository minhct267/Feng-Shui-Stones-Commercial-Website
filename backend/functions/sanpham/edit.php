        ...
        <div class="row">
            ...
            <main class="col-md-9 col-lg-10 ml-sm-auto">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-2 pb-1 mb-3 border-bottom">
                    <h1 class="h2">Thay đổi sản phẩm</h1>
                </div>
                <!--Lấy dữ liệu-->
                <?php
                //Hiển thị lỗi
                ...
                <div>
                    <form id="frmCreate" name="frmCreate" method="post" action="">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="sp_ten" name="sp_ten" placeholder="Tên loại sản phẩm" value="<?=$sanphamRow['sp_ten'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="sp_gia" class="col-sm-3 control-label">Giá <span style="color:red;">(*)</span> :</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="sp_gia" name="sp_gia" placeholder="Giá sản phẩm" value="<?=number_format($sanphamRow['sp_gia'], 2, ".", ",") . ' vnđ' ?>">
                                <small style="font-style:italic; color:red;">Chỉ nhập số</small>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="sp_giacu" class="col-sm-3 control-label">Giá sản phẩm hiện tại <span style="color:red;">(*)</span> :</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="sp_giacu" name="sp_giacu" placeholder="Giá cũ sản phẩm" value="<?=$sanphamRow['sp_gia'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="sp_ngaycapnhat" class="col-sm-3 control-label">Ngày cập nhật <span style="color:red;">(*)</span> :</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="sp_ngaycapnhat" name="sp_ngaycapnhat" placeholder="Ngày cập nhật" value="<?=$sanphamRow['sp_ngaycapnhat'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="sp_soluong" class="col-sm-3 control-label">Số lượng <span style="color:red;">(*)</span> :</label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control" id="sp_soluong" name="sp_soluong" placeholder="Số lượng" value="<?=$sanphamRow['sp_soluong'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="sp_mota_ngan" name="sp_mota_ngan" placeholder="Mô tả ngắn" value=""><?=$sanphamRow['sp_mota_ngan'] ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="sp_mota_chitiet" class="col-sm-3 control-label">Mô tả chi tiết <span style="color:red;">(*)</span> :</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" id="sp_mota_chitiet" name="sp_mota_chitiet" placeholder="Mô tả chi tiết" value=""><?=$sanphamRow['sp_mota_chitiet'] ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
